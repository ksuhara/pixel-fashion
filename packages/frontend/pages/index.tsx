      ...
      <Container maxW="container.xl" textAlign="center" pb="10">
        ...
        <Box as="section">
          ...
          <VStack my="8">
            ...
            ></Input>
            <Button mt="8" size="lg" colorScheme="blue" fontWeight="bold" onClick={deployNewContract}>
              Deploy
            </Button>
            {deployTxHash && (
              <Center>
                <Flex direction={{ base: "column", sm: "row" }} alignItems={"center"}>
                  <Link href={`${explorers[chainId]}${deployTxHash}`} isExternal>
                    <Text
                      mx="2"
                      isTruncated
                      w={{ base: "sm", sm: "md" }}
                  ...
                  {deployStatus == "ended" && <Icon as={FaCheckCircle} w={8} h={8} color="green"></Icon>}
                </Flex>
              </Center>
            )}
            <Text mt="2">
              Write this contract address down and keep it for yourself. This service will not save it.
            </Text>
            <Heading mt="2" fontSize="xl">
          ...
          <Box>
            ...
            <Text mt="2">Must be 32×32 png file. Colors should be less than 256</Text>
          </Box>
          ...
          <form onSubmit={generateSeed}>
            ...
            <br />
            <Button my="4" size="lg" colorScheme="blue" fontWeight="bold" type="submit" name="upload" disabled={!image}>
              ④Generate SVG
            </Button>
          </form>
        </Box>
        ...
        {currentAccount ? (
          <Button my="4" size="lg" colorScheme="blue" fontWeight="bold" onClick={mintNftHandler} disabled={!svgString}>
            ⑤Mint Pixel
          </Button>
        ) : (
